...
%changelog
* Sun Aug 02 2026 RPM Fusion Release Engineering <leigh123linux@rpmfusion.org> - 0.3.7-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-10
- Rebuilt for new VDR 2.8.2 API version 13

* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-9
- Rebuilt for new VDR 2.8.1 API version 12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-8
- Rebuilt for new VDR API version 2.7.9

* Tue Feb 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-7
- Rebuilt for new VDR API version 2.7.8

* Mon Feb 02 2026 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.3.7-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Aug 01 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-5
- Rebuilt for new VDR API version 2.7.7

* Sun Jul 27 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.3.7-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Jun 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-3
- Rebuilt for new VDR API version 2.7.6

* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-2
- Rebuilt for new VDR API version 2.7.5

* Sun Mar 16 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.3.7-1
- Update to 0.3.7

* Sun Mar 16 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.3.6-3
- Rebuilt for new VDR API version 2.7.4

* Wed Jan 29 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.3.6-2
...
* Tue Oct 22 2024 Martin Gansser <martinkg@fedoraproject.org> - 0.3.4-8
- Rebuilt for new VDR API version 2.7.3

* Tue Oct 01 2024 Martin Gansser <martinkg@fedoraproject.org> - 0.3.4-7
- Add vdr-tvguideng-EventID.patch for vdr-2.7.2

* Fri Jul 26 2024 Martin Gansser <martinkg@fedoraproject.org> - 0.3.4-6
- Rebuilt for new VDR API version 2.6.9

* Sun Apr 21 2024 Martin Gansser <martinkg@fedoraproject.org> - 0.3.4-5
- Rebuilt for new VDR API version

* Sun Feb 04 2024 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.3.4-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 26 2024 Martin Gansser <martinkg@fedoraproject.org> - 0.3.4-3
- Rebuilt for new VDR API version
